...
# 2 and employee 3. They both have importance value 3. So the total importance value of employee 1 is 5 + 3 + 3 = 11.
# Note:
...
class Solution(object):
    def getImportance(self, employees, id):
        ...
        return self.dfs(query_id, my_dict)

    def dfs(self, employee_id, emp_dict):
        """
        Recursive dfs
        """
        curr_employee = emp_dict[employee_id]

        return curr_employee.importance + sum(self.dfs(eid, emp_dict) for eid in curr_employee.subordinates)
